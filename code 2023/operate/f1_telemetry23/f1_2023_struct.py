...
class LapData(ctypes.LittleEndianStructure):
    ...
    _fields_ = [
        ...
        ('m_deltaToCarInFrontInMS',         ctypes.c_uint16), # Time delta to car in front in milliseconds
        ('m_deltaToRaceLeaderInMS',         ctypes.c_uint16), # Time delta to race leader in milliseconds
