...
from f1_2023_struct import *

UDP_IP = "0.0.0.0"
UDP_PORT = 20777

def get_telemetry():
    print(f"Server started on {UDP_PORT}")
    ...
    while True:
        ...
        match packetID:
            ...
            case 1:
                ...
                packet = PacketSessionData.from_buffer_copy(data[0:644])
            case 2:
                # Frequency: Rate as specified in menus
                packet = PacketLapData.from_buffer_copy(data[0:1131])
            case 3:
                # Frequency: When the event occurs
                packet = PacketEventData.from_buffer_copy(data[0:45])
            case 4:
                # Frequency: Every 5 seconds
                packet = PacketParticipantsData.from_buffer_copy(data[0:1306])
            case 5:
                # Frequency: 2 per second
                packet = PacketCarSetupData.from_buffer_copy(data[0:1107])
            case 6:
                # Frequency: Rate as specified in menus
            ...
            case 8:
                ...
                packet = PacketFinalClassificationData.from_buffer_copy(data[0:1020])
            case 9:
                # Frequency: Two every second when in the lobby
                packet = PacketLobbyInfoData.from_buffer_copy(data[0:1218])
            case 10:
            ...
            case 13:
                # Frequency: Rate as specified in menus
                packet = PacketMotionExData.from_buffer_copy(data[0:217])
            case 14:
